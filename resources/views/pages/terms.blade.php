...
<title>Terms of Service | Alumni Connect</title>
...
<h1 class="font-headline-lg text-headline-lg mb-6 text-on-surface dark:text-[#e3e3e3]">Terms of Service</h1>
<p class="font-body-lg text-body-lg text-secondary dark:text-[#a0a5a8] max-w-2xl mx-auto">
                These terms govern your use of the Alumni Connect platform. By joining our network, you agree to foster a professional, respectful, and safe community.
            </p>
...
<p class="text-body-md mb-4 dark:text-[#a0a5a8]">
                    By creating an account, logging in, or otherwise accessing the services provided by Alumni Connect ("we", "us", or "our"), you agree to be bound by these Terms of Service. If you do not agree to these terms, you may not register or use the platform.
                </p>
</section>
...
<p class="text-body-md mb-4 dark:text-[#a0a5a8]">
                    Alumni Connect is an exclusive network for verified graduates, current students, faculty, and administrative organizers. To maintain the integrity of our network, the following rules apply:
                </p>
<ul class="text-body-md text-secondary dark:text-[#a0a5a8]">
<li><strong>Eligibility:</strong> You must be an alumni, student, faculty, or registered organizer of our affiliated academic institutions.</li>
<li><strong>Verification:</strong> You must complete our verification process using your active university email or by submitting credentials for manual approval.</li>
<li><strong>Security:</strong> You are responsible for keeping your login credentials confidential. Any activity under your account is your responsibility.</li>
</ul>
</section>
...
<h3 class="font-headline-md text-headline-md mb-4 text-on-surface dark:text-[#e3e3e3]">A Trust-Based Network</h3>
<p class="text-body-md text-secondary dark:text-[#a0a5a8] mb-6">
                    Verification is a privilege that grants you access to verified peers, directory search, and direct mentorship matching. Misrepresentation of your academic or professional credentials will result in permanent account termination.
                </p>
<div class="flex items-center gap-4">
<div class="h-10 w-10 rounded-full bg-primary-fixed flex items-center justify-center">
<span class="material-symbols-outlined text-on-primary-fixed" data-icon="workspace_premium" data-weight="fill">workspace_premium</span>
</div>
<span class="text-label-sm font-bold text-on-surface-variant dark:text-[#c4c8b9]">100% Verified Members Only</span>
</div>
</div>
<section class="mb-16 border-l-2 border-outline-variant dark:border-[#444934] pl-8">
<h2 class="font-headline-md text-headline-md mb-6 text-on-surface dark:text-[#e3e3e3] flex items-center gap-3">
...
<p class="text-body-md mb-4 dark:text-[#a0a5a8]">
                    We expect all members to engage in respectful and professional interactions. When using our mentorship, messaging, or event planning tools, you agree to:
                </p>
<ul class="text-body-md text-secondary dark:text-[#a0a5a8]">
<li>Refrain from harassment, spamming, bulk marketing, or sending unsolicited sales communications.</li>
<li>Maintain the confidentiality of discussions held in mentorship portals or private messages.</li>
<li>Avoid sharing illegal, misleading, or offensive content on the community feed or profiles.</li>
</ul>
</section>
<section class="mb-16 border-l-2 border-primary-container pl-8">
<h2 class="font-headline-md text-headline-md mb-6 text-on-surface dark:text-[#e3e3e3] flex items-center gap-3">
...
<p class="text-body-md mb-6 text-secondary dark:text-[#a0a5a8]">
                    You own the content you post on Alumni Connect, including profile data and feed contributions. However, by uploading content, you grant us a non-exclusive, royalty-free, worldwide license to display and distribute it within the platform's ecosystem to facilitate professional networking. We retain all rights to our branding, algorithms, and interface designs.
                </p>
<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
<div class="p-4 bg-surface dark:bg-[#12140e] rounded-lg border border-outline dark:border-[#757962]">
<span class="text-label-sm block mb-1 font-bold text-primary">Your Content</span>
<span class="text-body-md dark:text-[#e3e3e3]">Owned by you, controlled by your privacy choices</span>
</div>
<div class="p-4 bg-surface dark:bg-[#12140e] rounded-lg border border-outline dark:border-[#757962]">
<span class="text-label-sm block mb-1 font-bold text-primary">Platform Brand</span>
<span class="text-body-md dark:text-[#e3e3e3]">Copyright © 2026 Alumni Connect</span>
</div>
</div>
</section>
<!-- Contact CTA -->
<section class="text-center py-12 border-t border-outline-variant dark:border-[#444934] mt-24">
<h2 class="font-headline-md text-headline-md mb-4 dark:text-[#e3e3e3]">Need clarification on these terms?</h2>
<p class="text-body-md text-secondary dark:text-[#a0a5a8] mb-8">Our legal and community moderation teams are available to address your inquiries.</p>
